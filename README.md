# LoRA Fine-Tuning of Llama 3.2 1B on C4 (Clean) — Interview Demo
...
- **Evaluate** (test the model on held-out C4 validation data):
  ...
  ```bash
  python evaluate.py --num-test-samples 200
  ```
...
6. **Quantifiable results**: Achieved 99.5% parameter reduction, 79.5% memory savings, and perplexity of 16.5 on held-out data.
